...
func New(token string) (*Bot, error) {
	...
	commands := []tgbotapi.BotCommand{
		...
		{Command: "metrics", Description: "Show internal metrics"},
		{Command: "newissue", Description: "Create a new issue"},
		{Command: "preview", Description: "Preview diff for a job"},
		{Command: "queue", Description: "List pending and running jobs"},
		{Command: "quickfix", Description: "Fix an issue directly without plan review"},
		{Command: "restart", Description: "Restart the Akama daemon (admin only)"},
		{Command: "retry", Description: "Retry a failed job"},
		{Command: "retry_all", Description: "Retry all failed jobs"},
